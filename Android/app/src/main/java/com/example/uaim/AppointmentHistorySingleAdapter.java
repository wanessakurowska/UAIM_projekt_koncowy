...
public class AppointmentHistorySingleAdapter extends ArrayAdapter<Appointment> {

    private final Activity context;
    private final List<Appointment> appointments;

    public AppointmentHistorySingleAdapter(Activity context, List<Appointment> appointments) {
