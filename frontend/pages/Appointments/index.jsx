...
const Appointments = () => {
  ...
  const [selectedAppointmentId, setSelectedAppointmentId] = useState(null); // Wybrana wizyta
  const [error, setError] = useState("");
  const [filter, setFilter] = useState("upcoming"); // "upcoming" lub "completed"
  const [successMessage, setSuccessMessage] = useState(""); // Informacja o sukcesie
  ...
  const cancelAppointment = async (appointmentId) => {
    try {
      ...
      // Odswież listę wizyt po anulowaniu
